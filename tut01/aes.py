#This is an implemeentation of AES from Scratch.
...
#     print(encrypt('my secret key', b'this is a test message'))
#     print(decrypt('my secret key',encrypt('my secret key', b'this is a test message')))
